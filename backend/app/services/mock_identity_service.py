...
DEMO_IDENTITIES = (
    ...
    # The 9 identities below are reserved, never-yet-verified demo accounts kept specifically for
    # a reviewer/checker to walk through a FULL first-time journey (identity verification ->
    # profile setup -> resume upload/parsing -> application review & submit, or the identified
    # complaint flow) without landing on a returning-user dashboard, since Rahul and Ananya above
    # already have a Cyber Warrior application on file from prior demo/testing. See
    # DEMO-CREDENTIALS.md for the full usage guide.
    {
        "demo_identity_id": "99000000000003",
        "synthetic_email": "rohan.mehta@demo.cyberrakshak.local",
        "registered_mobile": "+91 90000 00003",
        "full_name": "Rohan Mehta",
        "date_of_birth": date(1994, 6, 21),
        "gender": "Male",
        "address": "12 Koregaon Road",
        "city": "Pune",
        "state": "Maharashtra",
        "postal_code": "411001",
        "otp": "111222",
    ...
    {
        "demo_identity_id": "99000000000004",
        "synthetic_email": "priya.nair@demo.cyberrakshak.local",
        "registered_mobile": "+91 90000 00004",
        "full_name": "Priya Nair",
        "date_of_birth": date(1997, 11, 3),
        "gender": "Female",
        "address": "27 Marine Drive Lane",
        "city": "Kochi",
        "state": "Kerala",
        "postal_code": "682001",
        "otp": "222333",
    ...
    {
        "demo_identity_id": "99000000000005",
        "synthetic_email": "karan.verma@demo.cyberrakshak.local",
        "registered_mobile": "+91 90000 00005",
        "full_name": "Karan Verma",
        "date_of_birth": date(1992, 2, 17),
        "gender": "Male",
        "address": "5 Malviya Nagar",
        "city": "Jaipur",
        "state": "Rajasthan",
        "postal_code": "302001",
        "otp": "333444",
    ...
    {
        "demo_identity_id": "99000000000006",
        "synthetic_email": "sneha.iyer@demo.cyberrakshak.local",
        "registered_mobile": "+91 90000 00006",
        "full_name": "Sneha Iyer",
        "date_of_birth": date(1999, 9, 30),
        "gender": "Female",
        "address": "9 Anna Salai",
        "city": "Chennai",
        "state": "Tamil Nadu",
        "postal_code": "600001",
        "otp": "444555",
    ...
    {
        "demo_identity_id": "99000000000007",
        "synthetic_email": "arjun.malhotra@demo.cyberrakshak.local",
        "registered_mobile": "+91 90000 00007",
    ...
    {
        "demo_identity_id": "99000000000008",
        "synthetic_email": "neha.kapoor@demo.cyberrakshak.local",
        "registered_mobile": "+91 90000 00008",
        "full_name": "Neha Kapoor",
        "date_of_birth": date(1996, 7, 12),
        "gender": "Female",
        "address": "14 Hazratganj",
        "city": "Lucknow",
        "state": "Uttar Pradesh",
        "postal_code": "226001",
        "otp": "666777",
    ...
    {
        "demo_identity_id": "99000000000009",
        "synthetic_email": "vikram.choudhary@demo.cyberrakshak.local",
        "registered_mobile": "+91 90000 00009",
        "full_name": "Vikram Choudhary",
        "date_of_birth": date(1993, 12, 24),
        "gender": "Male",
    ...
    {
        "demo_identity_id": "99000000000010",
        "synthetic_email": "meera.joshi@demo.cyberrakshak.local",
        "registered_mobile": "+91 90000 00010",
        "full_name": "Meera Joshi",
        "date_of_birth": date(2000, 1, 28),
        "gender": "Female",
        "address": "8 MP Nagar",
        "city": "Bhopal",
        "state": "Madhya Pradesh",
    ...
    {
        "demo_identity_id": "99000000000011",
        "synthetic_email": "aditya.rao@demo.cyberrakshak.local",
        "registered_mobile": "+91 90000 00011",
        "full_name": "Aditya Rao",
        "date_of_birth": date(1991, 10, 9),
        "gender": "Male",
        "address": "16 Indiranagar 100 Feet Road",
        "city": "Bengaluru",
        "state": "Karnataka",
        "postal_code": "560001",
        "otp": "999000",
